...
let styles
const alertMessage = 'Photo added to camera roll!'

export default class ImageBrowser extends Component<Props, State> {
  ...
  fetchPhotos = () => {
    console.log('tes', UNSPLASH_API_KEY)
    this.setState({ loading: true })
    fetch(`https://api.unsplash.com/photos/?page=${this.state.page}&per_page=30&client_id=${UNSPLASH_API_KEY}`)
      .then(res => res.json())
      .then(images => {
